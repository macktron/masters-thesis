...
Passive electronic support measures record a time-ordered stream of pulse descriptor words in which pulses from several emitters are interleaved and each emitter may change its operating mode.
...
That split never learns the two partitions jointly from the interleaved stream, and it scales poorly when waveforms are agile and trains overlap.

This thesis treats the two partitions as a joint clustering problem.
