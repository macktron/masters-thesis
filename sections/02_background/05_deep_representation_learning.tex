...
\cref{sec:related:deep_clustering} surveys deep embedded clustering and prototype-based alternatives that couple encoder training with discrete structure, together with the gap relative to nested emitter--mode organization in \gls{elint} streams.
