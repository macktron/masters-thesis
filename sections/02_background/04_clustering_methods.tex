...
Mixture models such as a \gls{gmm} replace the hard assignment with soft responsibilities under a parametric density.
They still usually fix the number of components, and they remain sensitive to initialization and to elongated or overlapping structure.
When the number of concurrent emitters or modes is unknown and the embedding space may contain noise or irregular densities, density-based methods fit better.
