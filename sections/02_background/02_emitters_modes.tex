...
The remainder of this chapter supplies the feature representation (\cref{sec:bg:pdw}) and learning background needed to formalize such joint structure in the method.
