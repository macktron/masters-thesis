...
- `04_elint_pipeline.tex` — Walk through the canonical EW/ESM chain from reception and detection through parameter estimation and deinterleaving to the PDW interface and downstream ELINT. Label `sec:bg:elint_pipeline`. Add a pipeline figure under `figures/background/` and cite a standard EW/ESM text.
