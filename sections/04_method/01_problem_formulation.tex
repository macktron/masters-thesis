...
The proposed method estimates $\hat{\vect{y}}_n$ with a shared encoder and two separate encdoing and embedding branches: recording-local emitter labels supervise one branch, and globally shared mode labels make the other comparable across recordings.
