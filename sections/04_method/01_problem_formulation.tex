...
After the maps of \cref{sec:method:data} the encoder sees $d=7$ scaled coordinates.
...
Distinct mode counts per window for this corpus are given in \cref{sec:exp:datasets}.
