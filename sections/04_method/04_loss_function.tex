...
Smaller $\tau$ concentrates the gradient on the hardest negatives, while larger $\tau$ stabilizes early optimization, since the magnitude of the gradient is inversely proportional to $\tau$:
\[
\left\| \frac{\partial \Loss_{\mathrm{SC}}}{\partial \vect{z}_i} \right\| \propto \frac{1}{\tau}
\]
