...
- `04_attention_variants.tex` — Attention variants: pairwise physical bias on TOA and circular azimuth distance; single-coordinate RoPE (TOA on trunk/mode, recovered azimuth on the deinterleaving branch).
