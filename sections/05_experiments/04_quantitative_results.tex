...
This section reports clustering scores for jointly trained encoders that differ in the attention mechanism, together with a no-encoder Feature \gls{dbscan} control.
...
\begin{table}[tbp]
  \centering
  \small
  \caption{Emitter clustering on the test split. Entries are mean $\pm$ std over non-overlapping windows of length $L=2000$. Neural rows use $960$ windows from a single training seed. Feature \gls{dbscan} is not trained.}
  \label{tab:exp:attn_em}
  \begin{tabular}{@{}lccccc@{}}
    \toprule
    Model & $\ARI$ & $\AMI$ & Homogeneity & Completeness & $\lvert\hat{K}-K\rvert$ \\
    \midrule
    Feature DBSCAN & $0.578\pm0.348$ & $0.630\pm0.260$ & $0.976\pm0.049$ & $0.523\pm0.275$ & $7.04\pm5.85$ \\
...
\begin{table}[tbp]
  ...
  \begin{tabular}{@{}lccccc@{}}
    ...
    \midrule
    Feature DBSCAN & $0.811\pm0.250$ & $0.829\pm0.196$ & $0.962\pm0.064$ & $0.774\pm0.218$ & $4.99\pm3.99$ \\
...
Feature \gls{dbscan} sits well below every trained encoder.
...
Mode $\ARI$ is $0.811$, still below Vanilla.
