...
On the mode branch, Mode-only stays with Joint, apart from a few windows that contain one true mode and are split into extra clusters.
...
It also does not greatly outperform Mode-only on the mode metrics.
