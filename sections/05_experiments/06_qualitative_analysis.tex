...
Vanilla, RoPE-TOA, RoPE-az, and Bias score $\ARI=1$ on both branches of this window, with two emitters and four modes.
...
Vanilla, RoPE-TOA, RoPE-az, and Bias do not disagree on this window in $\ARI$, so the visual differences are layout, not a change in the discrete partition.
