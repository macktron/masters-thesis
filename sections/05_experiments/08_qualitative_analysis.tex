...
The tables in \cref{sec:exp:results,sec:exp:ablation,sec:exp:attention} average over hundreds of windows.
...
The embeddings are those of the five jointly trained encoders of \cref{sec:exp:attention}.
The single-task Vanilla geometries already appear in \cref{fig:exp:emb_ablation}.
...
\Cref{fig:exp:feat_maxmode} is a crowded counterpart: an overlapping evaluation window with $17$ distinct mode labels on four emitters.
