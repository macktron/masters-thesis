...
Gunn et al.\ stop at one partition. The Vanilla mode row of \cref{tab:exp:vanilla} is the addition, and \cref{tab:exp:ablation_loss} shows that it is not free: joint Vanilla deinterleaves less cleanly than an emitter-only copy of the same encoder.
