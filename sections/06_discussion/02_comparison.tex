...
Gunn et al.\ stop at one partition. The Vanilla mode row of \cref{tab:exp:vanilla} is the addition, and \cref{tab:exp:ablation_em,fig:exp:kcorr_ablation_em} show that it is not free: joint Vanilla deinterleaves less cleanly than an emitter-only copy of the same encoder.
...
A single embedding cannot keep both similarities, and \cref{tab:exp:ablation_em} is the empirical trace of that conflict in the shared trunk: joint training costs emitter agreement relative to the emitter-only ceiling.
