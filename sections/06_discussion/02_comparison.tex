...
On windows where frequency and pulse width collide, as in \cref{fig:exp:feat_maxemitters,fig:exp:feat_maxmode}, a metric on those coordinates alone is not enough. The learned embeddings still separate the platforms.
