...
That split does not produce embeddings that carry both partitions, and it scales poorly when waveforms are agile and trains overlap.
...
The experiments measure agreement with the simulator partitions on mixture windows of fixed length.
