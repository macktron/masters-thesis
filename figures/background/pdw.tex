...
\begin{tikzpicture}[
  ...
  \begin{scope}[shift={(8.95, 2.35)}]
    \pgfmathsetmacro{\aoa}{36}            % angle of arrival from boresight
    \pgfmathsetmacro{\arrowL}{0.95}       % length of the incoming-wave ray
    \pgfmathsetmacro{\arcR}{0.55}         % radius of the angle arc
